...
\cventry
	...
	{Switzerland}{}
	{Honors: Cum Laude} %Rank: 3\textsuperscript{th}/35} % Arguments not required can be left empty
\vspace{2mm}
\cventry
...
\begin{minipage}[c]{0.7\linewidth}
	...
	\cvitem{Databases}{PostgreSQL, SQL server, MySQL, Redshift}
...
\cvitem{Certifications}{Passed CFA Level II (2016)}
%--------------------------------------------------------------------
\end{document}